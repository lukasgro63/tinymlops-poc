...
CLASSES = {"red": INITIAL_IMAGE_DATA_DIR / "red", "green": INITIAL_IMAGE_DATA_DIR / "green", "negative": INITIAL_IMAGE_DATA_DIR / "negative"}
...
OUTPUT_STATE_FILENAME = "knn_initial_state_RGN.json"  # Red, Green, Negative
# --- ENDE KONFIGURATION ---
