...
class AsyncStoneDetectorApp:
    ...
    def initialize_tinylcm(self):
        ...
        self.model_manager = tinylcm.ModelManager(
        ...
        try:
            ...
            logger.info("FixedSyncClient initialized successfully")
        except Exception as e:
            logger.error(f"Failed to initialize FixedSyncClient: {e}")
            self.sync_client = None
        
        logger.info("TinyLCM components initialized")
